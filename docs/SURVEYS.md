...
## Survey links (replace with your Google Form URLs)
...
- Share links via email, WhatsApp, or in-app (Surveys page in MAP).
- Deadline: end of Feb / mid March (as agreed with P2H).
- Results: use Google Forms Responses and Summary; export to Sheets for the progress report if needed.
