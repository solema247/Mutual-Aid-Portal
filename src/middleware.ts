...
export async function middleware(req: NextRequest) {
  ...
  // Early return for login, change-password, forgot-password, reset-password, and create-test-user pages - skip session checks to avoid rate limits
  if (path === '/login' || path === '/change-password' || path === '/forgot-password' || path === '/reset-password' || path === '/create-test-user') {
