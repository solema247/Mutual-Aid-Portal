        ...
        {step === 'select' && !initialProjectId ? (
          ...
          step === 'select' && initialProjectId ? (
            ...
            <WizardFullscreenShell
              title={t('f5.modal.title')}
              expanded={wizardViewerExpanded}
              onExpandedChange={setWizardViewerExpanded}
              zoom={wizardZoom}
              onZoomChange={setWizardZoom}
              steps={[
                { id: 'activities', label: '1) Activities', completed: wizardProgress.activities, isCurrent: expectedWizardKind === 'activities' },
                { id: 'demographics', label: '2) Demographics', completed: wizardProgress.demographics, isCurrent: expectedWizardKind === 'demographics' },
                { id: 'questions', label: '3) Questions', completed: wizardProgress.questions, isCurrent: expectedWizardKind === 'questions' },
              ]}
              ...
              continueDisabled={
                !wizardProgress.activities || !wizardProgress.demographics || !wizardProgress.questions || !isSelectReportDateValid
              }
