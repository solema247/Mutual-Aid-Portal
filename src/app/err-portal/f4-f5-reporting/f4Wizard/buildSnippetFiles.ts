import type { RegionSelection, WizardKind, WizardPageEntry } from './types'
import { normalizeWizardPage } from './types'

/**
 * Crop viewer selections to PNG files for `/api/f4/parse-snips`.
...
export async function buildSnippetFilesFromSelections (
  ...
  for (let i = 0; i < selections.length; i++) {
    ...
    console.info('[F4 wizard] snip crop', {
      kind,
