  ...
  try {
    ...
    let formattedF1s = (data || []).map((f1: any) => {
      ...
      return {
        ...
        planned_activities: typeof f1.planned_activities === 'string' ? JSON.parse(f1.planned_activities || '[]') : f1.planned_activities || [],
        project_objectives: f1.project_objectives || null,
        ...
        source: f1.source || null,
        project_name: f1.project_name || null,
